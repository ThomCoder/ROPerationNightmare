...
RUN apt-get update && apt-get install -yq gcc make build-essential python3 python3-pip binutils patchelf python3-dev git libssl-dev libffi-dev gdb curl wget
